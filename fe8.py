...
class FE8(Rom):
    def __init__(self, file):   
        ...
        self.CHAR_UNIT_LENGTH = 20
#        self.CHAR_TABLE_INDIRECT = 0x17D60

        self.CLASS_TABLE = 0x807110
